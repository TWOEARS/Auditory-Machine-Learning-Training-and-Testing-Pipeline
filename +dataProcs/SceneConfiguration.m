classdef SceneConfiguration < handle
    ...
    methods
        ...
        function obj = SceneConfiguration() % creates a "clean" configuration
            ...
            obj.numOverlays = 0;
            obj.walls = dataProcs.ValGen( 'manual', [] );
        ...
        function addWalls( obj, walls )
            if ~isa( walls, 'dataProcs.WallsValGen' ), error( 'Use a dataProcs.WallsValGen' ); end;
            obj.walls = walls;
        end
        %% -------------------------------------------------------------------------------
        ...
        function confInst = instantiate( obj )
            ...
            confInst.walls = dataProcs.ValGen( 'manual', obj.walls.value );
