classdef SVMmodelSelectTrainer < ModelTrainers.HpsTrainer & Parameterized
    ...
    methods (Access = protected)
        ...
        function refinedHpsTrainer = refineGridTrainer( obj, hps )
            ...
            best3paramSets = hps.params(end-2:end);
            cRefinedRange = [floor( log10( min( [best3paramSets.c] ) ) ), ...
                             ceil( log10( max( [best3paramSets.c] ) ) )];
            gRefinedRange = [floor( log10( min( [best3paramSets.gamma] ) ) ), ...
                             ceil( log10( max( [best3paramSets.gamma] ) ) )];
            eRefinedRange = unique( [best3paramSets.epsilon] );
            kRefinedRange = unique( [best3paramSets.kernel] );
