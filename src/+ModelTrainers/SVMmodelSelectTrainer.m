classdef SVMmodelSelectTrainer < ModelTrainers.HpsTrainer & Parameterized
        ...
        function obj = SVMmodelSelectTrainer( varargin )
            ...
            obj.setParameters( true, ...
                ...
                'hpsCoreTrainerParams', ...
                    {'makeProbModel', false,...
                     'dataSelector',obj.dataSelector,'importanceWeighter',obj.importanceWeighter}, ...
                 varargin{:} );
    ...
    methods (Access = protected)
        ...
        function refinedHpsTrainer = refineGridTrainer( obj, hps )
            ...
            best6paramSets = hps.params(end-5:end);
            cRefinedRange = [floor( log10( min( [best6paramSets.c] ) ) ), ...
                             ceil( log10( max( [best6paramSets.c] ) ) )];
            gRefinedRange = [floor( log10( min( [best6paramSets.gamma] ) ) ), ...
                             ceil( log10( max( [best6paramSets.gamma] ) ) )];
            eRefinedRange = unique( [best6paramSets.epsilon] );
            kRefinedRange = unique( [best6paramSets.kernel] );
