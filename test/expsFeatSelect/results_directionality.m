...
boxplot_performance( ...
    'binaural vs monaural performance difference',...
    {'20dB','10dB','0dB', '-10dB'},...
    [1 1 1 1],...
    [],...%{'notch','off'},...
    reshape(cell2mat(tp_sc_azmSepGos_snrs(:,1,:,1,1)),1,[])-reshape(cell2mat(tp_sc_azmSepGos_snrs(:,2,:,1,1)),1,[]),...
    reshape(cell2mat(tp_sc_azmSepGos_snrs(:,1,:,1,2)),1,[])-reshape(cell2mat(tp_sc_azmSepGos_snrs(:,2,:,1,2)),1,[]),...
    reshape(cell2mat(tp_sc_azmSepGos_snrs(:,1,:,1,3)),1,[])-reshape(cell2mat(tp_sc_azmSepGos_snrs(:,2,:,1,3)),1,[]),...
    reshape(cell2mat(tp_sc_azmSepGos_snrs(:,1,:,1,4)),1,[])-reshape(cell2mat(tp_sc_azmSepGos_snrs(:,2,:,1,4)),1,[]) ); 
ylim( [-0.05,0.05] )
%% 
