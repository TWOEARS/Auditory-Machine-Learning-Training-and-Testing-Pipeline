...
if exist( 'test_performances_b','var' )  &&  ...
        size(test_performances_b,1) >= ii  &&  size(test_performances_b,2) >= cc  &&  ...
        size(test_performances_b,3) >= fc  &&  size(test_performances_b,4) >= aa  &&  ...
        size(test_performances_b,5) >= aatest  ...
        &&  ~isempty( test_performances_b{ii,cc,fc,aa,aatest} )
    continue;
end
