...
if exist( 'test_performances','var' )  &&  ...
        size(test_performances,1) >= ss  &&  size(test_performances,2) >= fc  &&  ...
        size(test_performances,3) >= aa  &&  size(test_performances,4) >= aatest  &&  ...
        size(test_performances,5) >= sstest  ...
        &&  ~isempty( test_performances{ss,fc,aa,aatest,sstest} )
    continue;
end
