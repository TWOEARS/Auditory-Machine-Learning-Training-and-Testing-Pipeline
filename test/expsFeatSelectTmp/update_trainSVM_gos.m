...
if exist( 'modelpathes_svm','var' )  &&  ...
    ...
    if exist( 'altmat', 'var' ) && isfield( altmat, 'modelpathes_svm' )  &&  ...
            ...
            size(altmat.modelpathes_svm,5) >= aatest  && size(altmat.modelpathes_svm,6) >= sstest  ...
            &&  ~isempty( altmat.modelpathes_svm{ss,ll,fc,aa,aatest,sstest} )
        modelpathes_svm{ss,ll,fc,aa,aatest,sstest} = altmat.modelpathes_svm{ss,ll,fc,aa,aatest,sstest};
