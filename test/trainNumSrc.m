...
% model creator GLMNET multinomial
...
% pipe.modelCreator = ModelTrainers.GlmNetRegressionLambdaSelectTrainer( ...
%     'performanceMeasure', @PerformanceMeasures.PoissonDevianceExplained, ...
%     'family', 'poisson', ...
%     'cvFolds', 5, ...
%     'alpha', 0.99 );
