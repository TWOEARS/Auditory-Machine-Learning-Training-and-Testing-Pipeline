function [B S_all stat] = sparse_coding(X_total, num_bases, beta, sparsity_func, epsilon, num_iters, batch_size, fname_save, pars, Binit, resample_size)
...
%
% Edited by Lucas Buerschaper <lbuerschaper@hotmail.com>
% April 2017
% - output <S_all> instead of <S> (we want all coefficients for input X)
% - default value of <pars.display_every> = 0
% - default value of <pars.save_every> = 0
% - default value of <pars.save_basis_timestamps> = false
